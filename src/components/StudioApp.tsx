    ...
    <main className="studio-shell">
      ...
      <section className="service-section" id="services">
        ...
        <div className="service-list">
          ...
          <div className="service-preview"><div className={`service-preview-image${services[activeService].id === "clothes" ? " service-preview-logo" : ""}`} style={{ backgroundImage: `url(${services[activeService].image})` }} /><div className="service-preview-copy"><span>{services[activeService].number} / 03</span><p>{services[activeService].description}</p><button onClick={() => openQuote(services[activeService].title)}>დეტალები <ArrowUpRight size={14} /></button></div></div>
        </div>
      </section>
